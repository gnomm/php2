...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 18 2018 г., 15:49
...
(14, 2, 1, 2, 'Черное платье с вырезом на спине', 'img\\products\\ARMANI EXCHANGE\\woman\\dresses\\dresses2.jpg', 'Платье ARMANI EXCHANGE <br>\r\n- происхождение бренда: Италия <br>\r\n- особенности модели: платье застегивается сбоку на молнию, длина по переду для размера XS (40-42) - 86 см <br>\r\n- цвет: черный/белый <br>\r\n- рекомендации по уходу: бережная стирка при температуре до 30°, гладить при температуре до 110°', '46% вискоза, 43% полиамид, 6% эластан, 5% полиэстер, вставки - искусственная кожа (100% полиэстер с полиуретановым покрытием)', 'Китай', 220, '2018-05-28 13:33:00', '8490', '7581e977-67f6-11e8-852c-00055d6c06bd'),
...
(67, 2, 1, 1, 'tee', 'eee', 'eee', 'eee', 'eee', 0, '2018-09-17 17:46:44', '2000', '1');
...
(67, 'Ura', '123'),
(68, '123', '456'),
(69, '123rsvkojbtjrbkfgblkjtg', '805'),
(70, '12', '4'),
(71, 'use', 'pas');
